...
function showExample() {
    getSrc().textContent = "Лучший способ узнать, как работает’генератор хэштегов» – вставить“некрасивый текст<с лишними пробелами         ,  скобками)апострафами;и любыми другими^символами.\n\
Вся «шелуха»   удалится|можно вставлять#ДажеХэштеги #из #результата;а потом к ним дописать ключевые слова.\n\
